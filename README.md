...
4. What is the purpose of using functions in code?
   Using functions helps us keep our code dry. We don't want to keep repeating the same thing over and over.

5. How do you access a key inside of an object inside of an array?
   you would access the object inside the array using bracket notations, and then access the key with dot notation. array[0].name
